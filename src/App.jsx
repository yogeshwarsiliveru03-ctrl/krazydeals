...
const defaultProducts = [
  ...
  { id:"6", name:"L'Oréal Hyaluronic Acid Serum", category:"Beauty", price:699, originalPrice:1299, discount:46, rating:4.4, reviews:11200,
  ...
  { id:"7", name:"Lakme Eyeconic Kajal Twin Pack", category:"Beauty", price:298, originalPrice:398, discount:25, rating:4.5, reviews:38500,
    ...
    affiliateLink:"https://www.meesho.com/lakme-eyeconic-kajal/p/itm", badge:"Top Pick", description:"12hr smudge-proof, ultra-dark black, 0.35g×2" },
];
...
function DealTicker({ products }) {
  const items = products.slice(0,6).map(p=>`🔥 ${p.name} — ₹${p.price?.toLocaleString()} (${p.discount}% OFF)`);
    ...
    <div onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        ...
        <div className="flex items-center gap-2 mt-auto">
          <span className="text-[17px] font-black text-gray-900">₹{product.price?.toLocaleString()}</span>
