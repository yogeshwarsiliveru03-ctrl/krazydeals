...
import { PLATFORMS, CAT_THEMES, CATEGORIES, ADMIN_PASSWORD, defaultProducts, detectPlatform, Field, ImageUploadField, Stars, Badge, ShopBtn, CatPill, ProductCard, StatsBar, FloatingOrbs, DealTicker, ProductModal, SettingsPanel } from "./AppParts";
...
export default function App() {
  ...
  const filtered=products.filter(p=>{
    ...
    return matchCat&&(!q||p.name.toLowerCase().includes(q)||p.category.toLowerCase().includes(q)||matchTags);
  }).sort((a,b)=>{
