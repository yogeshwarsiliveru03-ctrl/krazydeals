...
export { PLATFORMS, detectPlatform, CAT_THEMES, CATEGORIES, ADMIN_PASSWORD, defaultProducts, FloatingOrbs, DealTicker, Stars, BADGE_STYLES, Badge, ShopBtn, ProductCard, SkeletonCard, CatPill, Field, ImageUploadField, ProductModal, StatsBar, SettingsPanel, ScrollReveal, ProductPage };