    ...
    <div onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        ...
        <div className="flex items-center justify-between gap-1">
          <div className="flex items-center gap-1 flex-wrap">
            ...
            {product.subCategory && (
              <span className="text-[9px] font-bold px-2 py-0.5 rounded-full text-white"
                style={{ background:
                  product.subCategory==="Men"?"linear-gradient(135deg,#4facfe,#00f2fe)":
                  product.subCategory==="Women"?"linear-gradient(135deg,#f093fb,#f5576c)":
          ...
          <span className="text-[9px] font-bold px-2 py-0.5 rounded-full text-white shadow-sm flex-shrink-0"
        ...
        {product.tags && (
          <div className="flex flex-wrap gap-1 mt-1">
            {product.tags.split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(tag=>(
